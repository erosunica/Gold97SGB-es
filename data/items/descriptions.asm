...
CardKeyDesc:
	db   "Tubo de repuesto"
	next "para el S.S.AQUA.@"

MachinePartDesc:
	db   "ESFERA mística ha-"
	next "llada en la cueva.@"
...
PassDesc:
	db   "Pase para el CLUB"
	next "BATALLA de KANTO.@"
