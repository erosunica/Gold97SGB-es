...
; entries correspond to SPRITE_* constants
	overworld_sprite ChrisSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite ChrisBikeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite OakSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GRAY
	overworld_sprite RedSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
	overworld_sprite BlueSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite BillSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite ElderSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	overworld_sprite JanineSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite KurtSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	overworld_sprite MomSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite BlaineSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BROWN
	overworld_sprite RedsMomSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite DaisySpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite Oak2SpriteGFX, 12, WALKING_SPRITE, PAL_OW_GRAY
	overworld_sprite WillSpriteGFX, 12, STANDING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite ChuckSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite ClairSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite BrunoSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite MistySpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite LanceSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite SurgeSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GRAY
	...
	overworld_sprite SabrinaSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite TwinSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite YoungsterSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
	overworld_sprite LassSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite TeacherSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite SurfingPikachuSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite NurseSpriteGFX, 12, STANDING_SPRITE, PAL_OW_ORANGE
	overworld_sprite LinkReceptionistSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite SlowpokeSpriteGFX, 4, STILL_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite MonsterSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite FairySpriteGFX, 12, WALKING_SPRITE, PAL_OW_PINK
	overworld_sprite BirdSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	overworld_sprite DragonSpriteGFX, 12, WALKING_SPRITE, PAL_OW_ORANGE
	...
	overworld_sprite VirtualBoySpriteGFX, 4, STILL_SPRITE, PAL_OW_ORANGE
	overworld_sprite OldLinkReceptionistSpriteGFX, 12, STANDING_SPRITE, PAL_OW_ORANGE
	overworld_sprite RockSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
	overworld_sprite BoulderSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
	overworld_sprite MinelrSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
	overworld_sprite MineudSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
