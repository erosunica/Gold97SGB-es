...
; entries correspond to SPRITE_ANIM_FRAMESET_* constants
	...
	dw .Frameset_GSIntroHoOhBlissey
...
.Frameset_GSIntroHoOhBlissey:
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_1, 10
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_2,  9
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_3, 10
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_4, 10
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_3,  9
	frame SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_BLISSEY_5, 10
	dorestart
