...
BlossomiteFrontpic:  INCBIN "gfx/pokemon/blossomite/front.2bpp.lz"
MachampFrontpic:     INCBIN "gfx/pokemon/machamp/front.2bpp.lz"
DonmarinFrontpic:    INCBIN "gfx/pokemon/donmarin/front.2bpp.lz"
...
LuxwanFrontpic:      INCBIN "gfx/pokemon/luxwan/front.2bpp.lz"
...
MimmeoFrontpic:      INCBIN "gfx/pokemon/mimmeo/front.2bpp.lz"
...
BelledamFrontpic:    INCBIN "gfx/pokemon/belledam/front.2bpp.lz"
...
DodaerieFrontpic:    INCBIN "gfx/pokemon/dodaerie/front.2bpp.lz"
...
FlambearFrontpic:    INCBIN "gfx/pokemon/flambear/front.2bpp.lz"
...
PressioFrontpic:     INCBIN "gfx/pokemon/pressio/front.2bpp.lz"
...
KoltaFrontpic:       INCBIN "gfx/pokemon/kolta/front.2bpp.lz"
...
MolambinoFrontpic:   INCBIN "gfx/pokemon/molambino/front.2bpp.lz"
FlambearBackpic:     INCBIN "gfx/pokemon/flambear/back.2bpp.lz"
JungelaFrontpic:     INCBIN "gfx/pokemon/jungela/front.2bpp.lz"
...
BellignanFrontpic:   INCBIN "gfx/pokemon/bellignan/front.2bpp.lz"
ScientistPic:        INCBIN "gfx/trainers/scientist.2bpp.lz"
PidgeyBackpic:       INCBIN "gfx/pokemon/pidgey/back.2bpp.lz"
VulpiiiFrontpic:     INCBIN "gfx/pokemon/vulpiii/front.2bpp.lz"
...
PhandarinFrontpic:   INCBIN "gfx/pokemon/phandarin/front.2bpp.lz"
...
PupperonFrontpic:    INCBIN "gfx/pokemon/pupperon/front.2bpp.lz"
...
TykerFrontpic:       INCBIN "gfx/pokemon/tyker/front.2bpp.lz"
...
WearlycanFrontpic:   INCBIN "gfx/pokemon/wearlycan/front.2bpp.lz"
...
StraigarFrontpic:    INCBIN "gfx/pokemon/straigar/front.2bpp.lz"
...
BipullaFrontpic:     INCBIN "gfx/pokemon/bipulla/front.2bpp.lz"
...
ParasporFrontpic:    INCBIN "gfx/pokemon/paraspor/front.2bpp.lz"
...
CubburnFrontpic:     INCBIN "gfx/pokemon/cubburn/front.2bpp.lz"
...
LurreelFrontpic:     INCBIN "gfx/pokemon/lurreel/front.2bpp.lz"
...
DisturbanFrontpic:   INCBIN "gfx/pokemon/disturban/front.2bpp.lz"
...
PalssioFrontpic:     INCBIN "gfx/pokemon/palssio/front.2bpp.lz"
...
CoinpurFrontpic:     INCBIN "gfx/pokemon/coinpur/front.2bpp.lz"
...
WarfursFrontpic:     INCBIN "gfx/pokemon/warfurs/front.2bpp.lz"
...
TriculesFrontpic:    INCBIN "gfx/pokemon/tricules/front.2bpp.lz"
...
MoibelleFrontpic:    INCBIN "gfx/pokemon/moibelle/front.2bpp.lz"
PhanpyFrontpic:      INCBIN "gfx/pokemon/phanpy/front.2bpp.lz"
BurgelaFrontpic:     INCBIN "gfx/pokemon/burgela/front.2bpp.lz"
...
AngoreFrontpic:      INCBIN "gfx/pokemon/angore/front.2bpp.lz"
...
OrfryFrontpic:       INCBIN "gfx/pokemon/orfry/front.2bpp.lz"
...
LickilordFrontpic:   INCBIN "gfx/pokemon/lickilord/front.2bpp.lz"
...
BruinusFrontpic:     INCBIN "gfx/pokemon/bruinus/front.2bpp.lz"
...
KazappelinFrontpic:  INCBIN "gfx/pokemon/kazappelin/front.2bpp.lz"
...
StromenFrontpic:     INCBIN "gfx/pokemon/stromen/front.2bpp.lz"
