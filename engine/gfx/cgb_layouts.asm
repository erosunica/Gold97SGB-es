...
StatsScreenPagePals:
IF MGB
INCLUDE "gfx/stats/pages_mgb.pal"
ELSE
...
StatsScreenPals:
IF MGB
INCLUDE "gfx/stats/stats_mgb.pal"
ELSE
...
IF MGB
INCLUDE "gfx/pokedex/cursor_mgb.pal"
ELSE
...
IF MGB
INCLUDE "gfx/pokedex/question_mark_mgb.pal"
ELSE
...
IF MGB
INCLUDE "gfx/pokedex/slowpoke_mgb.pal"
ELSE
