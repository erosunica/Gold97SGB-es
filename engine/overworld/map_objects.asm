...
.ShadowObject:
	...
	db $fc, PAL_OW_GRAY, SPRITEMOVEDATA_SHADOW
...
.BoulderDustObject:
	db $fe, PAL_OW_GRAY, SPRITEMOVEDATA_BOULDERDUST
...
.EmoteObject:
	db $f8, PAL_OW_GRAY, SPRITEMOVEDATA_EMOTE
...
.skip4
	...
	add hl, bc
	add [hl]
	add 16 ;erosunica: align sprites to the tile grid
	ld e, a
	ld a, [wPlayerBGMapOffsetY]
	add e
