...
InitializeEventsScript:
	...
	setevent EVENT_YOUNGSTER_FROM_BIRDON_IN_GAME_HOUSE; makes youngster disappear from n64 house
	setevent EVENT_KURT_AND_CAPTAIN_AT_FIVE_FLOOR_TOWER; I added this, makes kurt and captain disappear until ho-oh
	...
	setevent EVENT_SUICUNE_IN_WHIRL_ISLAND; used to make suicune disappear
	...
	setevent EVENT_SANSKRIT_RUINS_OUTSIDE_SCIENTIST
	setevent EVENT_SANSKRIT_RUINS_RESEARCH_CENTER_SCIENTIST
	setevent EVENT_BOULDER_IN_MAGMA_SHAFT_1A
	setevent EVENT_BOULDER_IN_MAGMA_SHAFT_2A
	setevent EVENT_BOULDER_IN_MAGMA_SHAFT_3A
	setevent EVENT_BOULDER_IN_MAGMA_SHAFT_4A
	...
	setevent EVENT_CLAIR_INSIDE_HOUSE
	...
	setevent EVENT_SUNPOINT_DOCKS_NPCS
	setevent EVENT_FLORIA_AT_BELLIGNAN
	setevent EVENT_WESTPORT_CITY_MOVE_TUTOR
	setevent EVENT_SANSKRIT_RUINS_OUTSIDE_TOURIST_FISHER
	setevent EVENT_SANSKRIT_RUINS_OUTSIDE_TOURIST_YOUNGSTERS
	...
	setevent EVENT_GIRL_IS_BACK_AT_HOUSE
	...
	variablesprite SPRITE_STAND_ROCKET, SPRITE_ROCKET
	variablesprite SPRITE_STAND_CITY_IMPOSTOR, SPRITE_SURGE
