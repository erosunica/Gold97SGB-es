...
; Nihon Gym Leader TM gifts
	...
	const EVENT_ACTUALLY_GOT_TM46_THIEF; used instead for Thief
...
; Nihon story events
	...
	const EVENT_GOT_CUBBURN_FROM_OAK
	const EVENT_GOT_PALSSIO_FROM_OAK
	...
	const EVENT_KANTO_REGION_EXPLAINED_WEIRD_MAGIKARP
	const EVENT_KANTO_REGION_ASKED_FOR_MAGIKARP
	const EVENT_KANTO_REGION_ELIXIR_ON_STANDBY
	const EVENT_03B
	const EVENT_03C
	...
	const EVENT_GOT_CONFUSE_CLAW_IN_DARK_CAVE
...
; Nihon hidden items
	...
	const EVENT_MAGMA_SHAFT_1F_HIDDEN_BURN_HEAL
	...
	const EVENT_RYUKYU_THEATRE_HIDDEN_DIRE_HIT
	const EVENT_RYUKYU_THEATRE_HIDDEN_ULTRA_BALL
	const EVENT_RYUKYU_HOTEL_HIDDEN_MAX_POTION
	const EVENT_AMPARE_CAVERN_B1F_HIDDEN_ELIXER
	const EVENT_MT_FUJI_INTERIOR_LOWER_HIDDEN_MAX_POTION
	const EVENT_MT_FUJI_INTERIOR_LOWER_HIDDEN_FULL_HEAL
	const EVENT_DRAGONS_MAW_1F_HIDDEN_REVIVE
	const EVENT_DRAGONS_MAW_1F_HIDDEN_MAX_POTION
	const EVENT_DRAGONS_MAW_1F_HIDDEN_MAX_ELIXER
	...
	const EVENT_MT_FUJI_INTERIOR_UPPER_HIDDEN_PP_UP; victory road 2f tm toxic
...
; SWIslands story events
	...
	const EVENT_BOARDWALK_PATH_IS_OPEN
...
; SWIslands hidden items
	...
	const EVENT_BOULDER_MINE_B3F_HIDDEN_SUPER_POTION
	...
	const EVENT_MERIDIAN_PATH_HIDDEN_HYPER_POTION
	const EVENT_FOUND_MYSTERYBERRY_IN_KANTO_CAFE
...
; More Nihon story events
	...
	const EVENT_MISTYS_ROOM_ENTRANCE_CLOSED
	const EVENT_MISTYS_ROOM_EXIT_OPEN ; 310
...
; ???
	...
	const EVENT_WHITNEY_AQUARIUM_2F
	const EVENT_READ_OAKS_EMAIL
	const EVENT_TALKED_TO_KEN_AT_BEGINNING
	const EVENT_OAK_OAK_LAB_FRONT_ROOM
	const EVENT_RIVAL_OAK_LAB_FRONT_ROOM_2
	const EVENT_OAK_LAB_DEX_TABLE
	const EVENT_BLUE_OAK_LAB_FRONT_ROOM_2
	const EVENT_BOULDER_MINE_B4F_COVENANT_ORB
	const EVENT_SLOWPOKE_WELL_B2F_COVENANT_ORB
	const EVENT_WHIRL_ISLAND_B2F_COVENANT_ORB
	const EVENT_NAMED_MOM_CHECK_FOR_SAVES
	const EVENT_ENDON_CAVE_1F_SUPER_POTION
	const EVENT_ENDON_CAVE_1F_ULTRA_BALL
	const EVENT_ENDON_CAVE_1F_STEEL_SHELL
	...
	const EVENT_PICKED_UP_STAR_PIECE_KIKAI_STRAIT
	const EVENT_JADE_FOREST_HIDDEN_AWAKENING
	const EVENT_PICKED_UP_ROUTE_120_SUPER_REPEL
	const EVENT_KEY_GUY_IS_GONE
	const EVENT_SANSKRIT_ROCKET_HOUSE_KEY_ITEM
	...
	const EVENT_BOARDWALK_MOVE_TUTOR
	const EVENT_BOARDWALK_GAME_CORNER_MOVE_TUTOR
	const EVENT_READ_RIVAL_OAKS_EMAIL
	const EVENT_3B6
	const EVENT_3B7
	const EVENT_3B8
	const EVENT_3B9
...
; Elite Four and Champion
	...
	const EVENT_BEAT_ELITE_4_MISTY
...
; ???
	...
	const EVENT_RYUKYU_THEATRE_X_ACCURACY
	...
	const EVENT_MT_FUJI_INTERIOR_LOWER_X_SPECIAL
	...
	const EVENT_ROUTE_102_BELLIGNAN
...
; Nihon itemballs
	const EVENT_CUBBURN_POKEBALL_IN_OAK_LAB_BACK_ROOM
	const EVENT_PALSSIO_POKEBALL_IN_OAK_LAB_BACK_ROOM
	const EVENT_CHIKORITA_POKEBALL_IN_OAK_LAB_BACK_ROOM
	...
	const EVENT_BOULDER_MINE_B4F_HM_STRENGTH
	...
	const EVENT_DEEPWATER_EAST_RARE_CANDY
	const EVENT_MT_FUJI_INTERIOR_UPPER_HELIX_FOSSIL
	const EVENT_DEEPWATER_EAST_TM_SWAGGER
	...
	const EVENT_TEAM_ROCKET_BASE_B1F_TM_PSYCH_UP
	const EVENT_TEAM_ROCKET_BASE_B2F_PROTEIN
	const EVENT_TEAM_ROCKET_BASE_B2F_SNAKESKIN
	...
	const EVENT_ICED_CAVERN_B1F_WATER_TAIL
	...
	const EVENT_WHIRL_ISLAND_1F_MYSTIC_WATER
	...
	const EVENT_RYUKYU_THEATRE_MAX_ELIXER
	const EVENT_RYUKYU_THEATRE_PROTEIN
	const EVENT_RYUKYU_THEATRE_ESCAPE_ROPE
	const EVENT_RYUKYU_ELEVATOR_MAX_REVIVE
	const EVENT_RYUKYU_ELEVATOR_FULL_RESTORE
	...
	const EVENT_MT_FUJI_INTERIOR_LOWER_TM_EARTHQUAKE
	const EVENT_MT_FUJI_INTERIOR_LOWER_MAX_REVIVE
	const EVENT_MT_FUJI_INTERIOR_LOWER_FULL_RESTORE
	const EVENT_MT_FUJI_INTERIOR_LOWER_FULL_HEAL
	const EVENT_MT_FUJI_INTERIOR_LOWER_HP_UP
	const EVENT_DRAGONS_MAW_1F_DRAGON_FANG
	...
	const EVENT_ROUTE_106_GREAT_BALL
	...
	const EVENT_DEEPWATER_EAST_MAX_ETHER
	const EVENT_DEEPWATER_EAST_MAX_REVIVE
	const EVENT_BOULDER_MINE_B4F_GIGA_DRAIN
	const EVENT_MT_FUJI_INTERIOR_UPPER_NUGGET
	const EVENT_ENDON_CAVE_1F_DYNAMICPUNCH
	const EVENT_ENDON_CAVE_2F_ELIXER
	const EVENT_MT_FUJI_INTERIOR_UPPER_TOXIC
...
; Nihon people
	...
	const EVENT_RIVAL_MT_FUJI_INTERIOR_LOWER
	...
	const EVENT_SANSKRIT_RUINS_OUTSIDE_SCIENTIST
	const EVENT_SANSKRIT_RUINS_RESEARCH_CENTER_SCIENTIST
	const EVENT_SANSKRIT_RUINS_INNER_CHAMBER_TOURISTS
	const EVENT_BOULDER_IN_BLUE_FOREST_GYM_1
	const EVENT_BOULDER_IN_BLUE_FOREST_GYM_2
	const EVENT_BOULDER_IN_BLUE_FOREST_GYM_3
	const EVENT_BOULDER_IN_MAGMA_SHAFT_1
	const EVENT_BOULDER_IN_MAGMA_SHAFT_2
	const EVENT_BOULDER_IN_MAGMA_SHAFT_3
	const EVENT_BOULDER_IN_MAGMA_SHAFT_4
	const EVENT_BOULDER_IN_MAGMA_SHAFT_1A
	const EVENT_BOULDER_IN_MAGMA_SHAFT_2A
	const EVENT_BOULDER_IN_MAGMA_SHAFT_3A
	const EVENT_BOULDER_IN_MAGMA_SHAFT_4A
	...
	const EVENT_SANSKRIT_RUINS_KABUTO_CHAMBER_RECEPTIONIST
	...
	const EVENT_LANCES_ROOM_PROFESSOR_OAK
	...
	const EVENT_BOARDWALK_GAME_CORNER_MOVE_TUTOR_OLD ; didn't realize these were already here... erosunica: :P
; SWIslands people
...
; New to Crystal
	...
	const EVENT_SANSKRIT_RUINS_OUTSIDE_TOURIST_FISHER
	const EVENT_SANSKRIT_RUINS_OUTSIDE_TOURIST_YOUNGSTERS
	...
	const EVENT_PICKED_UP_MIRACLE_SEED_FROM_URASOE_PARK
	const EVENT_PICKED_UP_HYPER_POTION_FROM_MAGMA_SHAFT
	const EVENT_PICKED_UP_SMOKE_BALL_FROM_MAGMA_SHAFT
	const EVENT_PICKED_UP_CHARCOAL_FROM_HO_OH_ITEM_ROOM
	const EVENT_PICKED_UP_MAX_REVIVE_FROM_NANJO_FOREST
	const EVENT_PICKED_UP_ULTRA_BALL_FROM_NANJO_FOREST
	const EVENT_PICKED_UP_FULL_HEAL_FROM_NANJO_FOREST
	const EVENT_PICKED_UP_FULL_RESTORE_FROM_NANJO_FOREST
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_ISEN_LAB
	const EVENT_PICKED_UP_NUGGET_FROM_ISEN_LAB
	const EVENT_PICKED_UP_BERSERK_GENE_FROM_ISEN_LAB
	const EVENT_PICKED_UP_CLEANSE_TAG_FROM_SEASIDE_PATH
	...
	const EVENT_PICKED_UP_BRIGHTPOWDER_FROM_ZAPDOS_ROOM
	...
	const EVENT_BOULDER_MINE_B4F_DOME_FOSSIL
	const EVENT_DEEPWATER_PASSAGE_B2F_PROTEIN
	const EVENT_DRAGONS_MAW_TM_24_DRAGONBREATH
	const EVENT_DRAGONS_MAW_1F_MAX_ELIXER ; 7c0
	const EVENT_RYUKYU_THEATRE_ULTRA_BALL
	const EVENT_RYUKYU_HOTEL_CALCIUM
	const EVENT_RYUKYU_HOTEL_ULTRA_BALL
	const EVENT_RYUKYU_HOTEL_PP_UP
	...
	const EVENT_JOULE_CAVE_1F_THUNDER_TAIL
