; GetSGBLayout arguments (see engine/gfx/cgb_layouts.asm and engine/gfx/sgb_layouts.asm)
	...
	const SCGB_POKEDEX_ENTRY
	const SCGB_POKEDEX_INTO_ENTRY
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_RB_MEWMON
	const PREDEFPAL_RB_BLUEMON
	const PREDEFPAL_RB_REDMON
	...
	const PREDEFPAL_BETA_SHINY_GREYMON
