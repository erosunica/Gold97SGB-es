...
SPRITE_VARS EQU const_value
	...
	const SPRITE_ALLOY_RIVAL ; f5
	const SPRITE_STAND_ROCKET ; f6
	const SPRITE_STAND_CITY_IMPOSTOR ; f7
	const SPRITE_OLD_FUCHSIA_GYM_2 ; f8
	const SPRITE_OLD_FUCHSIA_GYM_3 ; f9
	const SPRITE_OLD_FUCHSIA_GYM_4 ; fa
